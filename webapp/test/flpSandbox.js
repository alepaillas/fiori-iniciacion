		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#alepaillasinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"alepaillasinvoices-display": {
								"semanticObject": "alepaillasinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alepaillas.invoices",
									"url": sap.ui.require.toUrl("alepaillas/invoices")
								}
							}
						}
					}
